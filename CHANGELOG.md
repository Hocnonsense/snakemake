...
## [8.0.0](https://github.com/Hocnonsense/snakemake/compare/v7.31.0...v8.0.0) (2023-08-02)


### ⚠ BREAKING CHANGES

* template rendering integration (yte and jinja2), require Python 3.6 as minimum version (f-string support) ([#1410](https://github.com/Hocnonsense/snakemake/issues/1410))
...
* Adding --cluster-cancel and --cluster-cancel-nargs ([#1395](https://github.com/Hocnonsense/snakemake/issues/1395)) ([0593de1](https://github.com/Hocnonsense/snakemake/commit/0593de134499712929ba75e65f65df90491eac2e))
...
* adding service jobs, i.e. the ability to define jobs that provide a resource for consumers (like a shared memory device or a database), and will be automatically terminated by Snakemake once all consumers are finished. ([#1413](https://github.com/Hocnonsense/snakemake/issues/1413)) ([a471adb](https://github.com/Hocnonsense/snakemake/commit/a471adbb785e5ac7f0c854fd09781c502b577c65))
...
* allow input, output, and params to be used in functions passed to report mark arguments ([#2081](https://github.com/Hocnonsense/snakemake/issues/2081)) ([93ff8b6](https://github.com/Hocnonsense/snakemake/commit/93ff8b604a152f50ca31389ecffe1a7527c5b5a8))
...
* cluster sidecar ([#1397](https://github.com/Hocnonsense/snakemake/issues/1397)) ([b992cd1](https://github.com/Hocnonsense/snakemake/commit/b992cd19dc1c011f536e3662a3ddffc8b1bb9f67))
...
* improved reports: more interactive and modern interface, ability to define a label based representation of files ([#1470](https://github.com/Hocnonsense/snakemake/issues/1470)) ([d09df0c](https://github.com/Hocnonsense/snakemake/commit/d09df0c6b02494829345f0af0fa8811007afa28b))
...
* LockException ([#1276](https://github.com/Hocnonsense/snakemake/issues/1276)) ([f5e6fa6](https://github.com/Hocnonsense/snakemake/commit/f5e6fa68a68640ed39df86c256d676f2e4efddfc))
...
* require at least Python 3.7 ([fd5daae](https://github.com/Hocnonsense/snakemake/commit/fd5daaeff070f9987dba411a0f5262c533a2f666))
...
* support for group local jobs by enabling optional groupid consideration in input functions ([#1418](https://github.com/Hocnonsense/snakemake/issues/1418)) ([5d45493](https://github.com/Hocnonsense/snakemake/commit/5d45493db4485af2f4b288b5002605c87315d2b7))
...
* template rendering integration (yte and jinja2), require Python 3.6 as minimum version (f-string support) ([#1410](https://github.com/Hocnonsense/snakemake/issues/1410)) ([e1cbde5](https://github.com/Hocnonsense/snakemake/commit/e1cbde5a378a29e3e7c7c16c73e08b35afa47a56))
...
* Zenodo remote provider for transparent storage on and retrieval from Zenodo ([#1455](https://github.com/Hocnonsense/snakemake/issues/1455)) ([4586ef7](https://github.com/Hocnonsense/snakemake/commit/4586ef7c9e5945568e9994a013235574c24d582f))
...
* add local marker for input files in cufflinks example. fixes issue [#1362](https://github.com/Hocnonsense/snakemake/issues/1362) ([90bc88b](https://github.com/Hocnonsense/snakemake/commit/90bc88b84282b477f481e368ad657056e131cbdc))
* add lock free mechanism for avoiding race conditions when writing persistence information; consider corrupt metadata records as non-existent ([#1745](https://github.com/Hocnonsense/snakemake/issues/1745)) ([71fe952](https://github.com/Hocnonsense/snakemake/commit/71fe9527bb7011ba01d25fdd21c102c135412c04))
* add missing report.templates.components module to setup.py ([cb4e3fe](https://github.com/Hocnonsense/snakemake/commit/cb4e3feaa192ed9c53ddb7c965cb5b71297710c9))
...
* always deploy conda envs in main process when assuming a shared file system (fixes issue [#1463](https://github.com/Hocnonsense/snakemake/issues/1463)) ([#1472](https://github.com/Hocnonsense/snakemake/issues/1472)) ([79788eb](https://github.com/Hocnonsense/snakemake/commit/79788eb5e8bd404e507ef7e54a0caa6103d90c4e))
...
* avoid incomplete remote files in case of errors and automatically retry download and upload ([#1432](https://github.com/Hocnonsense/snakemake/issues/1432)) ([8fc23ed](https://github.com/Hocnonsense/snakemake/commit/8fc23ed09f9c6de7519160797584ff9df3104939))
...
* avoid mutable default argument ([#1330](https://github.com/Hocnonsense/snakemake/issues/1330)) ([978cc93](https://github.com/Hocnonsense/snakemake/commit/978cc9327ce7deb517ad609977e1ce432c58c5e2))
...
* better error messages in case of missing files after latency period ([#1528](https://github.com/Hocnonsense/snakemake/issues/1528)) ([5b394c0](https://github.com/Hocnonsense/snakemake/commit/5b394c0319cfc5f8000b616d0f3c911a9091d05b))
...
* bug in pipe group handling that led to multiple assignments of the same group id to different groups; bug that accidentally added already running groups of the list of ready jobs (issue [#1331](https://github.com/Hocnonsense/snakemake/issues/1331)) ([#1332](https://github.com/Hocnonsense/snakemake/issues/1332)) ([1a9b483](https://github.com/Hocnonsense/snakemake/commit/1a9b483a6c675315d74bff791502c2bdd74609c1))
...
* change set to Set for python37 ([d2d8c3c](https://github.com/Hocnonsense/snakemake/commit/d2d8c3ca9dea3189df8245eb183dab64d716529c))
...
* convert conda env to string before checks ([#1382](https://github.com/Hocnonsense/snakemake/issues/1382)) ([7a8da9f](https://github.com/Hocnonsense/snakemake/commit/7a8da9fbf01a037a99ebaa3732fe25e87a96fcd2))
...
* delay evaluation of tmpdir to actual job execution, and not submission. This way, tmpdir can be dependent on the node context. ([#1860](https://github.com/Hocnonsense/snakemake/issues/1860)) ([4203556](https://github.com/Hocnonsense/snakemake/commit/420355662ebea0bc72c9bd6bca1eea5259f3b43e))
...
* disable mtime retrieval from github api for now. This quickly exceeds rate limits. ([1858bb9](https://github.com/Hocnonsense/snakemake/commit/1858bb912823da2021f88a9c0cdabe1ee1083575))
* display change warnings only for jobs that won't be executed otherwise ([086f60f](https://github.com/Hocnonsense/snakemake/commit/086f60f142721a6085b105bc4bbe12cccc9cee02))
* display wrapper or external script code in report [#1393](https://github.com/Hocnonsense/snakemake/issues/1393) ([#1404](https://github.com/Hocnonsense/snakemake/issues/1404)) ([a007bd1](https://github.com/Hocnonsense/snakemake/commit/a007bd11fb49a5765a643ec78e19f30b3a10dfab))
...
* do not apply module prefix in case of remote files ([5645b3f](https://github.com/Hocnonsense/snakemake/commit/5645b3f75066d8d1d8841b6e6732cd8ad098f67f))
* do not pass SNAKEMAKE_PROFILE into cluster-submit ([#1398](https://github.com/Hocnonsense/snakemake/issues/1398)) ([#1407](https://github.com/Hocnonsense/snakemake/issues/1407)) ([7189183](https://github.com/Hocnonsense/snakemake/commit/71891839e397130fb1af3e499d30fa9a953a93f7))
...
* do not require --cores or --jobs to be set when --cleanup-metadata is used. ([#1429](https://github.com/Hocnonsense/snakemake/issues/1429)) ([9c73907](https://github.com/Hocnonsense/snakemake/commit/9c739079bf3e6340facaa03f88f757df36f6dd91))
...
* do not wait for named or containerized conda envs ([#1473](https://github.com/Hocnonsense/snakemake/issues/1473)) ([6b1d09c](https://github.com/Hocnonsense/snakemake/commit/6b1d09c1e270348e8ef77d6ad8c24e1ca540215c))
...
* don't raise WorkflowError when entry is empty ([#1368](https://github.com/Hocnonsense/snakemake/issues/1368)) ([1fc6f7b](https://github.com/Hocnonsense/snakemake/commit/1fc6f7b5d7e7d7f40baab961db89c4b59c950bf7))
...
* failure to properly apply default remote prefix in combination with the unpack marker ([#1448](https://github.com/Hocnonsense/snakemake/issues/1448)) ([82666f1](https://github.com/Hocnonsense/snakemake/commit/82666f1b2b043f0a8de739d7027aba66eccdaee3))
...
* fix a bug leading to duplicate conda env initializations; fix display of jobs and output files with changes ([994b151](https://github.com/Hocnonsense/snakemake/commit/994b1510766083df7f22d10c0e6e4bb65ffdd710))
* fix assertion error in conda env file spec when applying wildcards (thanks [@ddesvillechabrol](https://github.com/ddesvillechabrol)) ([#1377](https://github.com/Hocnonsense/snakemake/issues/1377)) ([6200652](https://github.com/Hocnonsense/snakemake/commit/6200652b9aff2362a63581cee58eb9f9cae189da))
...
* fix false reruns after checkpoints ([#1907](https://github.com/Hocnonsense/snakemake/issues/1907)) ([dc5af12](https://github.com/Hocnonsense/snakemake/commit/dc5af12f54e774612bb1f8ead45e4597080dc100))
...
* fix issue when generating unit tests for rules with directory output ([#1385](https://github.com/Hocnonsense/snakemake/issues/1385)) ([7db614f](https://github.com/Hocnonsense/snakemake/commit/7db614fa1753179d2cdc20095df17d5ac2885ad0))
...
* fix None type error when invoking Workflow object manually ([#1366](https://github.com/Hocnonsense/snakemake/issues/1366)) ([fca3895](https://github.com/Hocnonsense/snakemake/commit/fca3895430c206fc159e71622ee567f77566980d))
...
* fix pepfile handling in case of module usage ([#1387](https://github.com/Hocnonsense/snakemake/issues/1387)) ([f097a76](https://github.com/Hocnonsense/snakemake/commit/f097a761472248d779113cdb22b5274395828bcb))
...
* fixed problem with leaked modifications when inheriting multiple times from the same rule ([#1957](https://github.com/Hocnonsense/snakemake/issues/1957)) ([2475cbc](https://github.com/Hocnonsense/snakemake/commit/2475cbcd74d9c9f62e07617751979bb00025850a))
...
* implement lock-free source file caching. This avoids hangs on network file systems like NFS. ([#1464](https://github.com/Hocnonsense/snakemake/issues/1464)) ([9520e98](https://github.com/Hocnonsense/snakemake/commit/9520e988a32f0c5369b4f2c68fdb741f21daa1a4))
...
* issue 1846 ([#1888](https://github.com/Hocnonsense/snakemake/issues/1888)) ([da2dfbd](https://github.com/Hocnonsense/snakemake/commit/da2dfbd765aa1e2a8da36d9eaa1ac9fcffa5e921))
* issue with duplicated prefix for checkpoints on cloud ([#1294](https://github.com/Hocnonsense/snakemake/issues/1294)) ([8ed0c8c](https://github.com/Hocnonsense/snakemake/commit/8ed0c8cb453b6ebf6df138391a0681ffc8442e09))
...
* keep flags with apply_wildcards on cloned IOFile ([#1416](https://github.com/Hocnonsense/snakemake/issues/1416)) ([23c943f](https://github.com/Hocnonsense/snakemake/commit/23c943f0e285f2dc725aa3e4a2e8798021085cb3))
...
* more details on input and output exceptions (missing input, protected output, etc.) ([#1453](https://github.com/Hocnonsense/snakemake/issues/1453)) ([8d64af2](https://github.com/Hocnonsense/snakemake/commit/8d64af2cb905fef95585055c7b69fd1c45d44108))
...
* more robust place for runtime source file cache ([#1436](https://github.com/Hocnonsense/snakemake/issues/1436)) ([2681f6f](https://github.com/Hocnonsense/snakemake/commit/2681f6f163832dfa5214e10f5234d256f5a13407))
...
* preserve empty names input or output file lists in params or resource functions ([0d19ab0](https://github.com/Hocnonsense/snakemake/commit/0d19ab0e6fcabe61b49d5ef9f2b293b9bcc06534))
...
* provide details on error when failing to evaluate default resources ([#1430](https://github.com/Hocnonsense/snakemake/issues/1430)) ([04f39a9](https://github.com/Hocnonsense/snakemake/commit/04f39a92f58c21265d859666bd63fe686e1d61f5))
* provide proper error when using immediate submit in combination with checkpoint jobs. ([#1437](https://github.com/Hocnonsense/snakemake/issues/1437)) ([865cf0f](https://github.com/Hocnonsense/snakemake/commit/865cf0f22656e22cd2450e5537421ce70c1705f9))
* quote jobid passed to status script to support multi-cluster Slurm setup ([#1459](https://github.com/Hocnonsense/snakemake/issues/1459)) ([0232201](https://github.com/Hocnonsense/snakemake/commit/023220160c6146810e3da2b277439441e8af9827))
...
* raise error if callable is passed to expand. ([#2171](https://github.com/Hocnonsense/snakemake/issues/2171)) ([1f28476](https://github.com/Hocnonsense/snakemake/commit/1f28476c35dc15a04e1032139b9dab5779801235))
...
* remove accidental pdb statement ([9c935f1](https://github.com/Hocnonsense/snakemake/commit/9c935f1566b976392393aeb00acf0e39eb159e19))
* remove deprecated and add missing arguments to internal functions ([93a7e39](https://github.com/Hocnonsense/snakemake/commit/93a7e39d9f225fac5ff5cb8cbe14500a09986ab3))
...
* remove raise that limits using --config with dicts ([#1341](https://github.com/Hocnonsense/snakemake/issues/1341)) ([bd65057](https://github.com/Hocnonsense/snakemake/commit/bd65057a782355ede86ad0bb912e063ff25a97f5))
...
* Repair MREs from [#823](https://github.com/Hocnonsense/snakemake/issues/823) ([#1203](https://github.com/Hocnonsense/snakemake/issues/1203)) ([b007979](https://github.com/Hocnonsense/snakemake/commit/b0079791718a390d1f920df15a405cf633314312))
...
* set mtime for cached source files [WIP] ([#1443](https://github.com/Hocnonsense/snakemake/issues/1443)) ([dd27209](https://github.com/Hocnonsense/snakemake/commit/dd27209b4a600d3704cabc39776dfef718129197))
...
* skip global report caption when using a module ([#1379](https://github.com/Hocnonsense/snakemake/issues/1379)) ([a755cee](https://github.com/Hocnonsense/snakemake/commit/a755ceefa478d51070f926beed9090067771edf1))
* skip type checks of missing dir in touch mode ([#2051](https://github.com/Hocnonsense/snakemake/issues/2051)) ([ae00c25](https://github.com/Hocnonsense/snakemake/commit/ae00c25541600dba14ad68f1145bab3c4455de19))
...
* small bug in snakemake.executors ([#1440](https://github.com/Hocnonsense/snakemake/issues/1440)) ([6e64292](https://github.com/Hocnonsense/snakemake/commit/6e64292cfa7d5bd9f6cb786681b3710ee51abc43))
...
* support python37 ([1021c2b](https://github.com/Hocnonsense/snakemake/commit/1021c2b75b2e0a67f6502f530eb0aa0496060b53))
...
* warn on non-file-modification-date changes like params, code, or input files ([#1419](https://github.com/Hocnonsense/snakemake/issues/1419)) ([b5f53f0](https://github.com/Hocnonsense/snakemake/commit/b5f53f09ae8c01e1223d2279c3a7f59819a8b44f))
* work around segfault with &gt;100 jobs in google life sciences backend ([#1451](https://github.com/Hocnonsense/snakemake/issues/1451)) ([2c0fee2](https://github.com/Hocnonsense/snakemake/commit/2c0fee2faec33185ca7fcd2276901977857e2c64))
* XRootDHelper.exists supports non posix filesystem (object store) ([#1348](https://github.com/Hocnonsense/snakemake/issues/1348)) ([7a3ad2f](https://github.com/Hocnonsense/snakemake/commit/7a3ad2f438586690dd40e4c8ec591d8c10b22b00))
...
* add install info of development (git) version to docs ([#1477](https://github.com/Hocnonsense/snakemake/issues/1477)) ([2a2d6cd](https://github.com/Hocnonsense/snakemake/commit/2a2d6cd15cf48278ff17470c7c1323e7ebc40bbd))
* add sentence about workflow template to docs ([#1369](https://github.com/Hocnonsense/snakemake/issues/1369)) ([5fabffb](https://github.com/Hocnonsense/snakemake/commit/5fabffbb4af8e9e122677e5adeaebf2d6bd0eeb3))
...
* explain relative path interpretation ([#1428](https://github.com/Hocnonsense/snakemake/issues/1428)) ([add9a05](https://github.com/Hocnonsense/snakemake/commit/add9a05eecf10f45113bc511a1d166e1708ff756))
...
* fix list display in docs ([3724367](https://github.com/Hocnonsense/snakemake/commit/372436747a97496466b60dc60ee0ebe4cfef1016))
* fix list display in docs ([2dd0e91](https://github.com/Hocnonsense/snakemake/commit/2dd0e91f8b7e13d0ffcebe4ed11024a39357ebc7))
...
* fix minor typos in a linting rule ([#2162](https://github.com/Hocnonsense/snakemake/issues/2162)) ([71e1171](https://github.com/Hocnonsense/snakemake/commit/71e1171a0dab824baed77bfe235268af9e095c1f))
* Fix problems with code blocks and broken internal link. ([#1424](https://github.com/Hocnonsense/snakemake/issues/1424)) ([5d4e7d8](https://github.com/Hocnonsense/snakemake/commit/5d4e7d8c4d7901c41bfb8f01c4b2c6551add59f7))
...
* fix tutorial setup instructions for MacOS. ([#1383](https://github.com/Hocnonsense/snakemake/issues/1383)) ([b57b749](https://github.com/Hocnonsense/snakemake/commit/b57b7493d372605323204122af859ede38864e4d))
...
* Fix typo and grammar mistake in scatter-gather section. ([#1441](https://github.com/Hocnonsense/snakemake/issues/1441)) ([f218aaa](https://github.com/Hocnonsense/snakemake/commit/f218aaad1b9b80074ea602cde0352c34c18e70b5))
* fix typo in installation.rst ([#1344](https://github.com/Hocnonsense/snakemake/issues/1344)) ([c45d47a](https://github.com/Hocnonsense/snakemake/commit/c45d47a79b78a1afed3b1319e6cafd1b2525fe43))
...
* temaplte rendering examples and available variables ([#1431](https://github.com/Hocnonsense/snakemake/issues/1431)) ([5995e9e](https://github.com/Hocnonsense/snakemake/commit/5995e9ebf7b037479b3f1317cb920773410bd2f2))
...
* update copyright year ([#1427](https://github.com/Hocnonsense/snakemake/issues/1427)) ([6b9f5da](https://github.com/Hocnonsense/snakemake/commit/6b9f5da0c986d5de444e00b45656dba85244a6c7))
